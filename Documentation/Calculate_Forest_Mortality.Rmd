...
Cal_Mort<-function(Subset){
  ...
  Relevent_Plots$MORTYR[Relevent_Plots$AGENTCD %in% c(20,30,40,60,80)]<-NA
...
Mod2<-lm(LrgMort[[5]][12:15]~c(LrgDeadYear,0))
summary(Mod2)
```
