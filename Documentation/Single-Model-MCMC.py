...
def manual_log_like_normal(WPB_LUT,Tmax_csv,Tmin_csv,CWD,xbind):  
  ...
  Outputmodelnew[Outputmodelnew<.1]=.1
...
x=[]
CovSet=pd.read_csv("Accept_Covariance.csv")
...
accepted, rejected,LLoutput,alllist,Treeslist= metropolis_hastings(manual_log_like_normal,### Computes Liklihood
                                         cov,
                                         [0.199883295,10.02792197,1.54953901,0.511107731,819.2135905,2,0.050218137], ### Initial postion
                                       15000, ###Iterations
