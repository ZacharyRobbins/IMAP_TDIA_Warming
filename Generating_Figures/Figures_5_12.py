...
### 1b
Validationset=pd.read_csv("C:/Users/zacha/Documents/GitHub/IMAP_Python_Project/WPB_Model/Figures_NCC/WPB_Data2/Param_MortValues_Reg.csv")
...
plt.plot(AllT, linreg.intercept + linreg.slope*AllT, 'r',label="Regression between model and data",
         color=color1)
plt.xlabel('Observed mortality  values',size=20)
plt.ylabel('Predicted mortality values',size=20)
ident = [0.0, 71.5]
...
plt.savefig('WPB_GCB_Figure4.png',dpi=200)
...
fig.tight_layout()
barWidth = 0.20
Validationset=pd.read_csv("C:/Users/zacha/Documents/GitHub/IMAP_Python_Project/WPB_Model/Figures_NCC/WPB_Data2/Val_MortValues_Reg.csv")
AllT=Validationset.Sim
LandscapeT=Validationset.Obs
...
plt.plot(AllT, linreg.intercept + linreg.slope*AllT, 'r',label="Regression between model and data",
         color=color1)
plt.xlabel('Actual mortality values',size=20)
plt.ylabel('Predicted mortality values',size=20)
ident = [0.0, 71.5]
plt.plot(ident,ident,"black",linestyle='dotted',label="1:1 line")
plt.ylim(-2.5,22.5)
...
plt.savefig('WPB_GCB_Figure5.png',dpi=200)
...
plt.text(2000, 58, '4 generations per year',size=20.0,  rotation=45,alpha=.6)
plt.text(2250, 50, '3 generations per year',size=20.0,  rotation=38,alpha=.6)
plt.text(2500, 25.2, '2 generations per year',size=20.0,  rotation=25,alpha=.6)

plt.xticks(list(range(1,len(Generations.Observed),365*2)), np.arange(2001,2018,2))



plt.ylabel("Generations Completed",fontsize=15)
...
plt.ylabel("Average Percent Larval Mortality",fontsize=15)
plt.xlim(6.7,18)
plt.xlabel("Year",fontsize=15)
plt.ylim(0.0,7)
#plt.ylabel("Trees surviving",fontsize=40)
...
#plt.xlim(2008,2018)
#plt.xlabel("Trees surviving",fontsize=20)
plt.ylabel("Annual Beetles in Flight",fontsize=15)
plt.xlabel("Year",fontsize=15)
#plt.ylabel("Trees surviving",fontsize=40)
plt.tick_params(labelsize=15)
plt.xticks(rotation=45)
...
#ax.set_xticks([])
plt.savefig('WPB_Figure4.png',dpi=200,bbox_inches='tight')